...
<template>
  <div v-if="imgList && imgList.length" :class="prefixCls" :style="getWrapStyle">
    <ElBadge v-if="simpleShow" :value="!showBadge || imgList.length == 1 ? 0 : imgList.length">
      <div class="img-div">
    ...
    <template v-for="(img, index) in imgList" v-else :key="img">
      <ElImage
        class="inline-image"
        :width="size"
