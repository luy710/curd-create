...
import { BasicTable, TableImg, useTable } from '@/components'
  ...
  <div class="p-4">
    <BasicTable @register="registerTable">
      ...
      <template #imgArr="{ row: record }">
        <TableImg :size="60" :simple-show="true" :img-list="record.imgArr" preview-teleported />
      </template>
      <template #imgs="{ row: record }">
        <TableImg :size="60" :img-list="record.imgs" preview-teleported />
      </template>
